...
Stability selection relies heavily on bootstrapping. An example of the bootstrapping approach is shown below (in reality 100-200 bootstrap resamples might be conducted). 
...
We can then apply our bootstrap function to each one of these 5 permuted datasets. We might perform 3 bootstrap samples for each of the 5 permuted datasets for this example (this is typically 20 bootstraps for each of 5 permutations in reality). The model would then be applied to each dataset within the following table. 
...
triangulated_stability$combi$stability %>%
    ...
    geom_vline(xintercept = triangulated_stability$combi$perm_thresh) +
    labs(
      x = "Stability (%)",
      y = "Bootstrap-p",
      colour = "Variable"
